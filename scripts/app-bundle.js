define('app',['exports', 'aurelia-dependency-injection', './shared/services/userservice'], function (exports, _aureliaDependencyInjection, _userservice) {
  'use strict';
  ...
  var App = exports.App = (_dec = (0, _aureliaDependencyInjection.inject)(_userservice.UserService), _dec(_class = function () {
...
define('main',['exports', './environment'], function (exports, _environment) {
  ...
  function configure(aurelia) {
    aurelia.use.standardConfiguration().feature('resources').feature('shared').plugin('aurelia-validation');
...
define('components/auth/authcomponent',['exports', 'aurelia-dependency-injection', 'aurelia-router', 'aurelia-validation', '../../shared/services/userservice', '../../shared/state/sharedstate', '../../shared/services/transactionservice'], function (exports, _aureliaDependencyInjection, _aureliaRouter, _aureliaValidation, _userservice, _sharedstate, _transactionservice) {
  ...
  var AuthComponent = exports.AuthComponent = (_dec = (0, _aureliaDependencyInjection.inject)(_transactionservice.TransactionService, _userservice.UserService, _sharedstate.SharedState, _aureliaRouter.Router, _aureliaValidation.ValidationControllerFactory), _dec(_class = function () {
    function AuthComponent(transactionService, userService, sharedState, router, controllerFactory) {
      ...
      _aureliaValidation.ValidationRules.ensure('email').required().email().ensure('password').required().minLength(6).ensure('confirmPassword').required().when(function (auth) {
        return auth.type === 'register';
      }).on(this);
    }

    AuthComponent.prototype.determineActivationStrategy = function determineActivationStrategy() {
      return _aureliaRouter.activationStrategy.replace;
    };

    AuthComponent.prototype.activate = function activate(params, routeConfig) {
    ...
    AuthComponent.prototype.submit = function submit() {
      var _this = this;
          ...
          if (response == "User registration was successful.") {
            return _this.userService.addRole(role).then(function (response) {
              if (response == "User role was added successful.") {
                _this.successRegister = "The user was registered successfully";
                _this.failRegister = null;
              } else {
                _this.successRegister = null;
                _this.failRegister = "An Error occued while registering the role to the user";
              }
            }, function (err) {
              _this.successRegister = null;
              _this.failRegister = "An Error occued while registering the user";
            });
          } else {
            _this.successRegister = null;
            _this.failRegister = "An Error occued while registering the user";
    ...
    AccountComponent.prototype.getBalance = function getBalance(year, month) {
      ...
      if (year && month) {
        ...
        this.accountService.getBalance(params).then(function (response) {
          ...
          _this.fail = "The account balance failed Loading.";
        });
      }
    };
...
define('components/report/reportcomponent',['exports', 'aurelia-framework', 'aurelia-dependency-injection', '../../shared/state/sharedstate', '../../shared/services/reportservice', 'node_modules/chart.js/dist/Chart.js', 'moment', 'lodash'], function (exports, _aureliaFramework, _aureliaDependencyInjection, _sharedstate, _reportservice, _Chart, _moment, _lodash) {
  ...
  exports.ReportComponent = undefined;
  ...
  var ReportComponent = exports.ReportComponent = (_dec = (0, _aureliaDependencyInjection.inject)(_sharedstate.SharedState, _aureliaFramework.BindingEngine, _reportservice.ReportService), _dec(_class = function () {
    function ReportComponent(sharedState, bindingEngine, reportService) {
    ...
    ReportComponent.prototype.attached = function attached() {
      if (this.sharedState.currentUser.role == 'ADMIN') {
        this.getReport(true);
      }
    };

    ReportComponent.prototype.getReport = function getReport(isInitialLoading) {
      var _this = this;
      ...
      this.reportService.getReport(params).then(function (response) {
        ...
        _this.lineOptions.title.text = 'Monthly Account Balances of year ' + _this.year;
        var ctx = _this.chart;
        ...
        if (!isInitialLoading) {
          _this.success = "The chart was generated successfully";
          _this.fail = null;
        }
      }, function (err) {
        _this.success = null;
        _this.fail = "Error occured wgile generating the chart";
      });
    };
...
define('components/updatebalance/updatebalancecomponent',['exports', 'aurelia-dependency-injection', 'aurelia-fetch-client', '../../shared/services/transactionservice', '../../shared/state/sharedstate', '../../shared/services/accountservice', 'moment'], function (exports, _aureliaDependencyInjection, _aureliaFetchClient, _transactionservice, _sharedstate, _accountservice, _moment) {
  ...
  exports.UpdateBalance = undefined;
  ...
  var UpdateBalance = exports.UpdateBalance = (_dec = (0, _aureliaDependencyInjection.inject)(_transactionservice.TransactionService, _accountservice.AccountService, _sharedstate.SharedState), _dec(_class = function () {
    function UpdateBalance(transactionService, accountService, sharedState) {
      _classCallCheck(this, UpdateBalance);

      this.transactions = [];
      this.months = [{ id: 0, name: "January" }, { id: 1, name: "February" }, { id: 2, name: "March" }, { id: 3, name: "April" }, { id: 4, name: "May" }, { id: 5, name: "June" }, { id: 6, name: "July" }, { id: 7, name: "August" }, { id: 8, name: "September" }, { id: 9, name: "October" }, { id: 10, name: "November" }, { id: 11, name: "December" }];
      this.excelData = [];
    ...
    UpdateBalance.prototype.attached = function attached() {
    ...
    UpdateBalance.prototype.getAllAccounts = function getAllAccounts() {
      var _this = this;
    ...
    UpdateBalance.prototype.addTransaction = function addTransaction() {
      var _this3 = this;
    ...
    UpdateBalance.prototype.deleteTransaction = function deleteTransaction(transactionId) {
      var _this4 = this;
    ...
    UpdateBalance.prototype.upload = function upload(files) {
      var _this5 = this;
      ...
      var Marketing = this.excelData[6][1];
      var ParkingFines = this.excelData[7][1];
    ...
    UpdateBalance.prototype.getAsText = function getAsText(files) {
      var disp = document.getElementById('fileDisplayArea');
      disp.innerText = '';
    ...
    UpdateBalance.prototype.convertTextToArray = function convertTextToArray(text) {
...
define('shared/layouts/footerlayout',["exports"], function (exports) {
  ...
  var FooterLayout = exports.FooterLayout = function FooterLayout() {
    _classCallCheck(this, FooterLayout);
  };
});
define('shared/layouts/headerlayout',['exports', 'aurelia-dependency-injection', 'aurelia-framework', 'aurelia-router', '../state/sharedstate', '../services/jwtservice', '../services/userservice'], function (exports, _aureliaDependencyInjection, _aureliaFramework, _aureliaRouter, _sharedstate, _jwtservice, _userservice) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.HeaderLayout = undefined;
  ...
  var HeaderLayout = exports.HeaderLayout = (_dec = (0, _aureliaDependencyInjection.inject)(_userservice.UserService, _sharedstate.SharedState, _jwtservice.JwtService, _aureliaRouter.Router), _dec2 = (0, _aureliaFramework.bindable)({ defaultBindingMode: _aureliaFramework.bindingMode.twoWay }), _dec(_class = (_class2 = function () {
    function HeaderLayout(userService, sharedState, jwtService, router) {
      _classCallCheck(this, HeaderLayout);

      this.activeRoute = '';

      _initDefineProp(this, 'routerConfig', _descriptor, this);
    ...
    HeaderLayout.prototype.routerConfigChanged = function routerConfigChanged(newValue, oldValue) {
      this.activeRoute = newValue.name;
    };

    HeaderLayout.prototype.logout = function logout() {
      this.userService.purgeAuth();
      this.router.navigateToRoute('home');
    };

    return HeaderLayout;
  }(), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, 'routerConfig', [_dec2], {
    enumerable: true,
    initializer: null
  })), _class2)) || _class);
});
define('shared/models/user',['exports'], function (exports) {
  'use strict';
...
define('shared/services/accountservice',['exports', 'aurelia-dependency-injection', './apiservice'], function (exports, _aureliaDependencyInjection, _apiservice) {
  'use strict';
  ...
  var AccountService = exports.AccountService = (_dec = (0, _aureliaDependencyInjection.inject)(_apiservice.ApiService), _dec(_class = function () {
    ...
    AccountService.prototype.getBalance = function getBalance(params) {
      return this.apiService.get('/api/Balance', params);
    };

    AccountService.prototype.getAllAccounts = function getAllAccounts() {
...
define('shared/services/apiservice',['exports', './config', 'aurelia-fetch-client', 'aurelia-dependency-injection', 'querystringify', './jwtservice', './servicehelper'], function (exports, _config, _aureliaFetchClient, _aureliaDependencyInjection, _querystringify, _jwtservice, _servicehelper) {
  'use strict';
  ...
  var qs = _interopRequireWildcard(_querystringify);
  ...
  var ApiService = exports.ApiService = (_dec = (0, _aureliaDependencyInjection.inject)(_aureliaFetchClient.HttpClient, _jwtservice.JwtService), _dec(_class = function () {
    ...
    ApiService.prototype.setHeaders = function setHeaders() {
      var headersConfig = {
    ...
    ApiService.prototype.get = function get(path, params) {
      var options = {
        method: 'GET',
        headers: this.setHeaders()
      };
      return this.http.fetch('' + _config.config.api_url + path + '?' + qs.stringify(params), options).then(_servicehelper.status).catch(_servicehelper.parseError);
    };

    ApiService.prototype.put = function put(path) {
      ...
      return this.http.fetch('' + _config.config.api_url + path, options).then(_servicehelper.status).catch(_servicehelper.parseError);
    };

    ApiService.prototype.post = function post(path) {
      var body = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    ...
    ApiService.prototype.postForLogin = function postForLogin(path) {
      var body = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

      return this.http.fetch(_config.config.api_url + '/token', {
        method: 'POST',
    ...
    ApiService.prototype.delete = function _delete(path) {
      var options = {
        method: 'DELETE',
        headers: this.setHeaders()
      };
...
define('shared/services/articleservice',['exports', 'aurelia-dependency-injection', './apiservice'], function (exports, _aureliaDependencyInjection, _apiservice) {
  'use strict';
  ...
  var ArticleService = exports.ArticleService = (_dec = (0, _aureliaDependencyInjection.inject)(_apiservice.ApiService), _dec(_class = function () {
    ...
    ArticleService.prototype.getList = function getList(type, params) {
      return this.apiService.get('/articles' + (type === 'feed' ? '/feed' : ''), params);
    };

    ArticleService.prototype.get = function get(slug) {
      return this.apiService.get('/articles/' + slug).then(function (data) {
        return data.article;
      });
    };

    ArticleService.prototype.destroy = function destroy(slug) {
      return this.apiService.delete('/articles/' + slug);
    };

    ArticleService.prototype.save = function save(article) {
      if (article.slug) {
        return this.apiService.put('/articles/' + article.slug, { article: article }).then(function (data) {
          return data.article;
        });
      } else {
        return this.apiService.post('/articles/', { article: article }).then(function (data) {
          return data.article;
        });
      }
    };

    ArticleService.prototype.favorite = function favorite(slug) {
      return this.apiService.post('/articles/' + slug + '/favorite');
    };

    ArticleService.prototype.unfavorite = function unfavorite(slug) {
...
define('shared/services/config',['exports'], function (exports) {
  'use strict';
...
define('shared/services/jwtservice',['exports'], function (exports) {
  ...
  var JwtService = exports.JwtService = function () {
    function JwtService() {
      _classCallCheck(this, JwtService);
    }

    JwtService.prototype.getToken = function getToken() {
      return window.localStorage['jwtToken'];
    };

    JwtService.prototype.saveToken = function saveToken(token) {
      window.localStorage['jwtToken'] = token;
    };

    JwtService.prototype.destroyToken = function destroyToken() {
...
define('shared/services/reportservice',['exports', 'aurelia-dependency-injection', './apiservice'], function (exports, _aureliaDependencyInjection, _apiservice) {
  ...
  var ReportService = exports.ReportService = (_dec = (0, _aureliaDependencyInjection.inject)(_apiservice.ApiService), _dec(_class = function () {
    ...
    ReportService.prototype.getReport = function getReport(params) {
...
define('shared/services/servicehelper',["exports"], function (exports) {
  "use strict";
  ...
  function parseError(error) {
    if (!(error instanceof Error)) return new Promise(function (resolve, reject) {
      return reject(error);
    });
  }
});
define('shared/services/transactionservice',['exports', 'aurelia-dependency-injection', './apiservice'], function (exports, _aureliaDependencyInjection, _apiservice) {
  'use strict';
  ...
  var TransactionService = exports.TransactionService = (_dec = (0, _aureliaDependencyInjection.inject)(_apiservice.ApiService), _dec(_class = function () {
    ...
    TransactionService.prototype.getAll = function getAll(params) {
      return this.apiService.get('/api/Transactions', params);
    };

    TransactionService.prototype.get = function get(slug) {
      return this.apiService.get('/api/transactions/' + slug).then(function (data) {
        return data.transaction;
      });
    };

    TransactionService.prototype.destroy = function destroy(slug) {
      return this.apiService.delete('/api/transactions/' + slug);
    };

    TransactionService.prototype.save = function save(transaction) {
      if (transaction.slug) {
        return this.apiService.put('/api/transactions/' + transaction.slug, { transaction: transaction }).then(function (data) {
          return data.transaction;
        });
      } else {
    ...
    TransactionService.prototype.saveExcelBalanceData = function saveExcelBalanceData(excelData) {
      return this.apiService.post('/api/transactions/excelData', excelData).then(function (data) {
        return data.transaction;
      });
    };
...
define('shared/services/userservice',['exports', 'aurelia-dependency-injection', './apiservice', './jwtservice', '../models/user', '../state/sharedstate', 'aurelia-router'], function (exports, _aureliaDependencyInjection, _apiservice, _jwtservice, _user, _sharedstate, _aureliaRouter) {
  'use strict';
  ...
  var UserService = exports.UserService = (_dec = (0, _aureliaDependencyInjection.inject)(_apiservice.ApiService, _jwtservice.JwtService, _sharedstate.SharedState, _aureliaRouter.Router), _dec(_class = function () {
    function UserService(apiService, jwtService, sharedState, router) {
    ...
    UserService.prototype.populate = function populate() {
      var _this = this;
    ...
    UserService.prototype.setAuth = function setAuth(user) {
      this.jwtService.saveToken(user.access_token);
      this.sharedState.currentUser = user;
      this.sharedState.isAuthenticated = true;
    };

    UserService.prototype.purgeAuth = function purgeAuth() {
      this.jwtService.destroyToken();
      this.sharedState.currentUser = new _user.User();
      this.sharedState.isAuthenticated = false;
    };

    UserService.prototype.attemptAuth = function attemptAuth(credentials) {
      var _this2 = this;

      this.purgeAuth();

      return this.apiService.postForLogin('/token', credentials).then(function (user) {
        if (user.access_token) {
          _this2.setAuth(user);
          return _this2.getUserInfo().then(function (info) {
            if (info.Role) {
              user.role = info.Role;
              _this2.setAuth(user);
...
define('shared/state/sharedstate',['exports', '../models/user'], function (exports, _user) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.SharedState = undefined;
  ...
  var SharedState = exports.SharedState = function SharedState() {
...
define('text!shared/layouts/headerlayout.html', ['module'], function(module) { module.exports = "<template><nav class=\"navbar navbar-light\"><div class=\"container\"><a class=\"navbar-brand\" route-href=\"route: home\">Account Balance Viewer</a><ul class=\"nav navbar-nav pull-xs-right\"><li class=\"${'nav-item' + (activeRoute === 'home' ? ' active' : '')}\"><a class=\"nav-link\" route-href=\"route: home\">Home</a></li><li class=\"${'nav-item' + (activeRoute === 'updatebalance' ? ' active' : '')}\"><a class=\"nav-link\" route-href=\"route: updatebalance\">Update Balance</a></li><li class=\"${'nav-item' + (activeRoute === 'reports' ? ' active' : '')}\"><a class=\"nav-link\" route-href=\"route: reports\">Generate Reports</a></li><li class=\"${'nav-item' + (activeRoute === 'login' ? ' active' : '')}\" show.bind=\"!sharedState.isAuthenticated\"><a class=\"nav-link\" route-href=\"route: login\">Sign In</a></li><li class=\"${'nav-item' + (activeRoute === 'register' ? ' active' : '')}\" show.bind=\"sharedState.currentUser.role=='ADMIN'\"><a class=\"nav-link\" route-href=\"route: register\">Register New Users</a></li><li class=\"nav-item\" show.bind=\"sharedState.isAuthenticated\"><a class=\"nav-link\" click.delegate=\"logout()\">${sharedState.currentUser.userName} Sign Out</a></li></ul></div></nav></template>"; });
