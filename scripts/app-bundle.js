      ...
      if (this.type == 'login') {
        ...
        this.userService.register(_credentials).then(function (response) {
          if (response == "User registration was successful.") {
            _this.userService.addRole(role).then(function (response) {
...
define('components/report/reportcomponent',['exports', 'aurelia-framework', 'aurelia-dependency-injection', '../../shared/state/sharedstate', '../../shared/services/reportservice', 'node_modules/chart.js/dist/Chart.js', 'moment', 'lodash'], function (exports, _aureliaFramework, _aureliaDependencyInjection, _sharedstate, _reportservice, _Chart, _moment, _lodash) {
  ...
  var ReportComponent = exports.ReportComponent = (_dec = (0, _aureliaDependencyInjection.inject)(_sharedstate.SharedState, _aureliaFramework.BindingEngine, _reportservice.ReportService), _dec(_class = function () {
    ...
    ReportComponent.prototype.getReport = function getReport() {
      var _this = this;
    ...
    UserService.prototype.attemptAuth = function attemptAuth(credentials) {
      ...
      return this.apiService.postForLogin('/token', credentials).then(function (user) {
        if (user.access_token) {
          _this2.setAuth(user);
          _this2.getUserInfo().then(function (info) {
            if (info.Role) {
              user.role = info.Role;
              _this2.setAuth(user);
